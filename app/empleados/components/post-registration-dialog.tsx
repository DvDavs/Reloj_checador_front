      ...
      <DialogContent className='sm:max-w-[500px] bg-zinc-900 border-zinc-800 text-white'>
        <DialogHeader className='text-center space-y-4'>
          ...
          <DialogDescription className='text-zinc-300 text-base'>
            El empleado{' '}
            <span className='font-semibold text-white'>{employeeName}</span> ha
            sido creado correctamente en el sistema.
          </DialogDescription>
        </DialogHeader>

        <div className='pt-6 pb-2'>
          <h3 className='text-lg font-medium text-center mb-6 text-zinc-200'>
