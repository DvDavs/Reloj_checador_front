...
export const CompactHandSelector = ({
    ...
    // Define finger regions for the right hand (scaled down)
    const rightHandFingerRegions = [
        { id: 1, x: 14, y: 86, width: 17, height: 17 }, // Thumb
        { id: 2, x: 41, y: 32, width: 15, height: 56 }, // Index
        { id: 3, x: 62, y: 20, width: 13, height: 65 }, // Middle
        { id: 4, x: 82, y: 31, width: 14, height: 55 }, // Ring
        { id: 5, x: 102, y: 49, width: 12, height: 45 }, // Pinky
    ];

    // Define finger regions for the left hand (scaled down)
    const leftHandFingerRegions = [
        { id: 6, x: 120, y: 85, width: 17, height: 15 }, // Thumb
        { id: 7, x: 93, y: 32, width: 14, height: 56 }, // Index
        { id: 8, x: 74, y: 20, width: 13, height: 65 }, // Middle
        { id: 9, x: 53, y: 31, width: 15, height: 55 }, // Ring
        { id: 10, x: 35, y: 50, width: 13, height: 45 }, // Pinky
    ];

    const getFingerStatus = (index: number): "registered" | "available" => {
        return registeredFingerIndices.includes(index)
            ? "registered"
            : "available";
    };
                    ...
                    <TooltipTrigger asChild>
                        <motion.div
                            ...
                            animate={{
                                backgroundColor: isRegistered
                                    ? "#22c55e"
                                    : "rgba(113, 113, 122, 0.3)", // green-500 | zinc-500 con transparencia
                                opacity: 1,
                                scale: 1,
                            }}
                            whileHover={{
                        ...
                        >
                            {isRegistered && showDeleteMode ? (
                                ...
                                >
                                    {/* No mostramos el ID para un look más limpio */}
                                </span>
                            )}
                        </motion.div>
                    </TooltipTrigger>
                    ...
                    <div className="relative w-[150px] h-[180px]">
                        ...
                        {leftHandFingerRegions.map((finger) => (
                            <Finger
                                ...
                                finger={finger}
                                isRegistered={
                                    getFingerStatus(finger.id) === "registered"
                                }
                            />
                        ))}
                    </div>
